...
return array_map('realpath', [
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Contracts/Config/Repositories.php',
    ...
    $basePath.'/vendor/laravel/framework/src/Illuminate/Config/Repositories.php',
